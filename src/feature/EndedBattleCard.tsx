...
interface EndedBattleCardProps {
  battle: LivestreamBattle;
  onJoin: (battle: LivestreamBattle) => void;
}

const EndedBattleCard: React.FC<EndedBattleCardProps> = ({ battle, onJoin }) => {
  return (
    <Card className="overflow-hidden hover:shadow-md transition-shadow">
      <div className="relative">
        ...
        />
        <Badge className="absolute top-2 right-2 bg-gray-500 flex items-center gap-1">
...
export default EndedBattleCard;
